...
class Response extends Message implements ResponseInterface
{
     ...
     */
	 ...
	 public function __construct($protocol_version, $status_code = null, $reason_phrase = '', $headers = [], $body = null)
	 {
    ...
    public function withStatus($code, $reasonPhrase = '')
    {
		...
		return new self($this->getProtocolVersion(), $code, $reasonPhrase, $this->getHeaders(), $this->getBody());
    }
